...
#                    --logs-bucket emr-demo-logs-123456789012-us-east-1
...
def main():
    ...
    bootstrap_bucket = f'emr-bootstrap-{account_id}-{region}'
    ...
    cfn_params.append({'ParameterKey': 'LogsBucket', 'ParameterValue': args.logs_bucket})
...
def parse_args():
    ...
    parser.add_argument('--logs-bucket', required=True, help='LogsBucket: Name of EMR Logs Bucket')
