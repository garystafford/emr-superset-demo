...
# Purpose: EMR bootstrap script that installs Apache Superset
...
python3 -m pip install PyAthenaJDBC>1.0.9 PyAthena>1.2.0 sqlalchemy-redshift pyhive mysqlclient
...
export SUPERSET_WEBSERVER_PORT=${SUPERSET_PORT}
